...
//watch: two args - first is what is being watched, second is a callback function of what to do when it changes
...
//can't watch an object property directly, so we use function
watch(
  () => wizard1.value.name, //first arg is a getter function that returns this value to be watched
  (newValue, oldValue) => {
    console.log(
...
watch(
  [number, () => wizard1.value.name, wizard2], //arg1 is the source, an array
  (newValue, oldValue) => {
    console.log(
