<template>
  ...
  <table>
    ...
    <!-- loop through filtered users defined in script -->
...
let numberOfActiveUsers = computed(() => {
  ...
  return users.value.filter((user) => user.isActive).length //remember .value because it is a ref object
})

//compare to method call
