<template>
  ...
  <ul>
    <!-- v-for in element that should be repeated, not the parent list -->
    <!-- use v-bind to provide unique key attribute for each user item -->
  ...
  <table>
    ...
    <!-- v-for in row element to be repeated, not table element -->
