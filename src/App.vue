...
//import vue component to use it in template
...
//don't need to define setup - everything in script above this is in the setup method
...
onMounted(() => {
  ...
  console.log(title.value) //works once the component is mounted.
})
onBeforeUpdate(() => {
